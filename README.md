...
기능이 점차 늘어나는 과정에서 코드 구조를 나누고 모듈화하는 방식을 적용해 보며, 유지보수와 확장성을 고려한 개발 방식에 대해 학습했습니다.<br><br>
...
이 프로젝트를 통해 외부 API를 Unity 환경에 연결하고, AI의 결과를 실제 콘텐츠에 반영하는 기본적인 시스템 통합 과정을 경험했습니다.<br><br>
