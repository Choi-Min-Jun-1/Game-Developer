...
기능이 점차 늘어나는 과정에서 코드 구조를 나누고 모듈화하는 방식을 적용해 보며, 유지보수와 확장성을 고려한 개발 방식에 대해 학습했습니다.
...
이 프로젝트를 통해 외부 API를 Unity 환경에 연결하고, AI의 결과를 실제 콘텐츠에 반영하는 기본적인 시스템 통합 과정을 경험했습니다.
...
또한 처음 개발을 접하는 팀원에게 구현 방식을 설명하고 코드 이해를 도우며, 다른 사람에게 개발 내용을 전달하고 함께 문제를 해결하는 협업 경험을 쌓았습니다.
...
GitHub를 통한 버전 관리와 코드 피드백을 경험했으며, 팀원들과 기능을 나누어 개발하고 발생한 문제를 함께 해결하는 과정을 경험했습니다.
